...
import "./MixItemDagOneParentOnlyOwnerProxy.sol";


contract MixItemDagOneParentOnlyOwnerTest is DSTest {
    ...
    MixItemDagOneParentOnlyOwnerProxy mixItemDagOneParentOnlyOwnerProxy;

    function setUp() public {
        mixItemStoreRegistry = new MixItemStoreRegistry();
        mixItemStore = new MixItemStoreIpfsSha256(mixItemStoreRegistry);
        mixItemDagOneParentOnlyOwner = new MixItemDagOneParentOnlyOwner(mixItemStoreRegistry);
        mixItemDagOneParentOnlyOwnerProxy = new MixItemDagOneParentOnlyOwnerProxy(mixItemDagOneParentOnlyOwner);
    }
